...
LLM_PARAM_DIR = os.path.join(BASE_DIR, "outputs", "llm_predictions_feedback")
LLM_TRAJ_DIR = os.path.join(BASE_DIR, "outputs", "llm_trajectories_feedback")
LLM_OUTCOME_DIR = os.path.join(BASE_DIR, "outputs", "llm_outcomes_feedback")
...
def main():
    ...
    for fname in pred_files:
        case_id = fname.replace("_feedback.json", "")

        gt_param_path = os.path.join(PSEUDO_PARAM_DIR, f"{case_id}_carla.json")
        pred_param_path = os.path.join(LLM_PARAM_DIR, f"{case_id}_feedback.json")
    ...
    out_csv = os.path.join(OUT_DIR, "feedback_vs_pseudogt_eval.csv")
